    ...
    layui.use('table', function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {field:'productionPrice', title: '车辆售价', align:'center'},
                {field:'productionNumber', title: '车辆产销数', align:'center'},
                {field:'productionVolume', title: '车辆销售额', align:'center',templet:function (d) {
                        return Number(d.productionPrice) * Number(d.productionNumber);
                    }},
        ...
        table.on('tool(demo)', function(obj) {
            ...
            if (obj.event == 'edit') {
                layer.open({
                    ...
                    anim: 0,
                    shade: [0.5, 'rgb(0,0,0)'],
                    content: '/page/CarManager/productionEdit',
        ...
        $('.btnAdd').on('click',function(){
            layer.open({
                ...
                anim: 0,
                shade: [0.5, 'rgb(0,0,0)'],
                content: '/page/CarManager/productionAdd',
                zIndex: layer.zIndex, //重点1
