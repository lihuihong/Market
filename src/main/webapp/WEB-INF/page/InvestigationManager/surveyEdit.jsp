...
<div>
    <form class="layui-form frameContent" lay-filter="form">
        <div class="layui-form-item">
            <div class="layui-form-label">问卷名称</div>
            <input type="hidden" name="surveyId">
            <div class="layui-input-block">
                <input type="text" name="surveyName" required lay-verify="required" placeholder="请输入问卷名称" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-form-label">问卷简介</div>
            <div class="layui-input-block">
                <textarea name="surveyDesc" required lay-verify="required" placeholder="请输入问卷简介"  class="layui-textarea"></textarea>
            </div>
        </div>
        <div class="frameBtn">
